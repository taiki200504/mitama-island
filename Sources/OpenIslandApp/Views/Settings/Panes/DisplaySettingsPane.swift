...
/// The display pane: where the island sits, how big it gets, which facts a
/// session row carries, and what the closed island and its session list show.
struct DisplaySettingsPane: View {
    ...
    var body: some View {
        SettingsPane(tab: .display) {
            ...
            notchSection
            sessionCardSection
            DisplayIslandSection(model: model)
            diagnosticsSection
        }
    }
