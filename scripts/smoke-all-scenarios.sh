...
scenarios=(closed peekBand sessionList approvalCard questionCard completionCard longCompletionCard planApproval completionBanner longQuestionCard ambientBoard linkstart sneakPeekPop closedAccessoryTimer shelfSurface unlockScan timerSurface eventInProgress clipboardSurface)
